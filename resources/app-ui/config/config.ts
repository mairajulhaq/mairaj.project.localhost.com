...
const sites = [
  {
    type: 'local', url: 'http://mairaj.project.localhost.com'
  },
  {
    type: 'staging', url: 'https://mairaj.project.wpvisions.com'
  },
  {
    type: 'live', url: 'https://mairaj.project.localhost.com'
  }
];


const FileManagerWebpackPlugin = require('filemanager-webpack-plugin');
const DevelopmentZipVersionFolder = '../../../mairaj-project-development-latest-version/mairaj.project.localhost.com';
const DevelopmentZipFileSource = '../../../mairaj-project-development-latest-version';
const ProductionZipVersionFolder = '../../../mairaj-project-production-latest-version/mairaj.project.localhost.com';
const ProductionZipFileSource = '../../../mairaj-project-production-latest-version';

export default defineConfig({

  favicons: [
    '/mairaj-project-favicon.png',
  ],
